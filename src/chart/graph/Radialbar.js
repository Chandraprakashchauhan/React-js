...
const Radialbar = (props) => {
    ...
    return (
        <>
            <Chart type='radialBar' width={props.w} height={props.h}
                series={[95, 30, 90, 50, 90, 50]}
                options={{
                    // colors: ['#1ab7ea', '#0084ff', '#39539E', '#0077B5'],
                    labels: name,
                    title: { xt: 'RadialBar', style: { fontSize: 20 } },
                    plotOptions: {
                        radialBar: {
                            offsetY: 0, offsetX: 0, startAngle: 0, endAngle: 360,
                            hollow: {
                                margin: 3, size: '20%', background: 'transparent',
                            ...
                            dataLabels: {
                                name: { show: true, fontSize: '30px' },
                                value: {// show: false, 
                                    fontSize: '20px'
                                },
                                total: { show: true, label: 'Total', formatter: function (w) { return 400 } }
                            },
                        }
                    },
                    legend: {
